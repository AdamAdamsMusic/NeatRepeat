...
var PluginParameters = [
    {name:"Trigger Note", type:"menu", valueStrings:midiNotes, defaultValue:48},
    {name:"Learn", type:"momentary", defaultValue:0},
    {name:"NoteOff delay", type:"lin", numberOfSteps:398, minValue:10, maxValue:2000, defaultValue:100}
    {name:"Use original velocity", type:"check", }
];
...
function HandleMIDI(event) {
    if (event instanceof NoteOn) {
        if (learning) {
            ...
            if (lastNote != null) {
                ...
                newEvent.sendAfterMilliseconds(GetParameter("NoteOff delay"));
                newEvent.trace();
            }
        } else {
    ...
    } else if (event instanceof NoteOff && lastNote != null && event.pitch == lastNote.pitch) {
